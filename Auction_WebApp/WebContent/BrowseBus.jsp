...
<body>
	...
	<h1> Browse Auction For Buses</h1>
	<h2> Filter By</h2>
	...
	Search the List by Make: <input type="text" size="25" id="myInput" onkeyup="myFunction()" placeholder="Search by Make" title="Type in search">
	Size: <input type="text" size="25" id="myInput2" onkeyup="myFunction2()" placeholder="Search by Category" title="Type in search"><br>
	...
	<table border="1" id = "AuctionItems">
		...
		<%
			try{
				...
				if(All == "*")
				{	
					sqlStmnt = "select vp.Vin_Number, vp.Make, vp.Model, vp.Model_Year, vp.Category, bp.Size, bp.Capacity, aStart.Close_Date_Time, aStart.Highest_Bid from Bus_Posts as bp, Vehicle_Posts as vp, Auction_Start as aStart where " + "vp.Make = \""+ Make +"\"" +" and "+ "vp.Model_year = \" "+ year +"\"" + " and " + "vp.Vin_Number = aStart.Vin_Number and bp.Vin_Number = aStart.Vin_Number Order by Vin_Number" ;
					
				}
				else
				{
					sqlStmnt = "select vp.Vin_Number, vp.Make, vp.Model, vp.Model_Year, vp.Category, bp.Size, bp.Capacity, aStart.Close_Date_Time, aStart.Highest_Bid from Bus_Posts as bp, Vehicle_Posts as vp, Auction_Start as aStart where vp.Vin_Number = aStart.Vin_Number and bp.Vin_Number = aStart.Vin_Number Order by Vin_Number" ;				
				...
				<td><%=resultSet.getString("bp.Size") %></td>
				<td><%=resultSet.getString("bp.Capacity") %></td>			
