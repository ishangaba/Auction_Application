...
<title>Change Transaction Method</title>
</head>
<body>
	...
	<%
		try {
			...
			String update = "UPDATE User SET Transaction_method = '" + newT + "' WHERE Username = '" + session.getAttribute("Modify User") + "'";
			...
			connect.close();
			out.print("Transaction Method Changed!");
